...
class ResponseCode {
  ...
  static const int INTERNAL_SERVER_ERROR =
      500; // failure, crash happened on server side
...
class ResponseMessage {
  ...
  static const String NOT_FOUND =
      AppStrings.notFoundError; // failure, API URL is not correct
  static const String INTERNAL_SERVER_ERROR =
      AppStrings.internalServerError; // failure, crash on API side
  ...
  static const String CACHE_ERROR = AppStrings
      .defaultError; // issue in getting data from local source (cache)
